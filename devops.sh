...
build_and_deploy () {
    ...
    time BRANCH=$trimmed_branch PROJECT=$PROJECT docker-compose -f docker-compose.yml build --build-arg MY_GITHUB_TOKEN_CLASSIC=$MY_GITHUB_TOKEN_CLASSIC --parallel
